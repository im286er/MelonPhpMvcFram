...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3030358b93c1434c882-52772007',
  'function' => 
  array (
  ),
  'variables' => 
...
<section id="secondary_bar">
    ...
    <div class="breadcrumbs_container">
        <article class="breadcrumbs"><a href="admin.php?controller=admin">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">管理员管理列表</a></article>
    </div>
...
<section id="main" class="column">
    ...
    <article class="module width_full">
        <header><h3 class="tabs_involved">管理员管理列表</h3>
        </header>
